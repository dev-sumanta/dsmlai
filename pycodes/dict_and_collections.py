# -*- coding: utf-8 -*-
"""
Created on Thu Oct 19 12:02:22 2017
...
target_number = 100
non_primes = set(x for y in range(2,
                 int(sqrt(target_number) + 1))
                 for x in range(2*y, target_number, y))
print(non_primes)
...
# find the only pythagorean triplet with sum = 1000
sum_thou = [(x, y, z) for x in range(3, 1000)
...
print([(x, y, z) for x in range(1, 999)
       for y in range(x, 999)
       for z in range(y, 999)
